    ...
    public partial class chooseYourOwnAdventure : Form
    {
        ...
        private void chooseYourOwnAdventure_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.B)
            {
                ...
                else if ( scene == 21 && theNumber < 66) { scene == 43}
            }
            else if (e.KeyCode == Keys.B)
            {
                if (scene == 2) { scene = 5; }
                ...
                switch (scene)
                {
                    ...
                    case 3:
                        ...
                        bOutputLabel.Text = "You hate blood and know you can't help so you head to the water.";
                        cOutputLabel.Text = "";
                        break;
                    case 4:
                        situationLabel.Text = "You head into the woods but throughout your journey you trip and end up falling for what seems like miles down a steep hill and you land on an unnfortunately pointy pile of rocks. Your injuries are too extensive and you slowly accept your death.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 5:
                        situationLabel.Text = "You get to highground and spot the front end of the plane a while down the beach to your right. Then to your left a few miles down, smoke is emerging from just inside the woods. The smoke is thick but you can tell it's the tail end of the plane, you go...";
                    ...
                    case 11:
                        ...
                        break;
                    case 12:
                        situationLabel.Text = "After further search You discover the pilot is dead but a few feet away you see someone who could be the copilot he doesn't look any better than the pilot but you check his pulse anyways. It's weak but it's there he is still alive, you choose to ";
                        aOutputLabel.Text = "Try to save him, he will know as much as the pilot did.";
                        bOutputLabel.Text = "Know you don't have enough medical knowledge to save him and you might end up injuring him further.";
                        cOutputLabel.Text = "";
                        break;
                    case 13:
                        ...
                        break;
                    case 14:
                        situationLabel.Text = "It's been several hours and one has come it is now starting to get dark, you...";
                        aOutputLabel.Text = "Start to make a fire.";
                        bOutputLabel.Text = "Try to find some food.";
                        cOutputLabel.Text = "Go to find somewhere safe and sheltered in the forest so you can sleep.";
                        break;
                    case 15:
                        situationLabel.Text = "You get to the other survivors but become overwhelmed by all the injury and disaster, you...";
                        aOutputLabel.Text = "Hand the firat aid kit to someone more qualified to help, then go for a walk on tour own to calm yourself down.";
                        bOutputLabel.Text = "Ask someone to fix up your arm before you continue on to help the others.";
                        cOutputLabel.Text = "Power through and start to help right away.";
                        break;
                    case 16:
                        situationLabel.Text = "You finally come across what appears to be a stationary transmitter but you have no technology knowledge and don't know what to do, you continue on to...";
                        ...
                        break;
                    case 17:
                        situationLabel.Text = "You begin helping a man who is concerned as his dog was on the plane as well. He begs you to help find the dog. He tells you how special this dog is to him and informs you he is adventurous, so he's probably in the woods and he goes by the anme Hulio. You tell him...";
                        ...
                        break;
                    case 18:
                        situationLabel.Text = "You arrive at the tail and precariously search it. You find a flare gun with only one flare. If you fire there is a 65% chance of someone spotting the flare or you wait until nightfall which brings many other dangers, though, there is then an 85% chance of someone spotting your flare. You choose to...";
                    ...
                    case 19:
                        ...
                        bOutputLabel.Text = "Go into the woods there must be some fresh water.";
                        cOutputLabel.Text = "Head to the ocean, it's closest and you are desperate.";
                        break;
                    case 20:
                    ...
                    case 23:
                        ...
                        aOutputLabel.Text = "Go to into the forest to get some wood";
                    ...
                    case 24:
                        ...
                        break;
                    case 25:
                        situationLabel.Text = "When roaming the forest you come across what seems to be a dog barking and running back and forth. You don't think he's wild but there's no garuntee, you...";
                        ...
                        break;
                    case 26:
                        situationLabel.Text = "As you go for your lonely, calming walk you are mangled by a large animal, uh oh.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 27:
                        ...
                        break;
                    case 28:
                        situationLabel.Text = "The lady you are helping tells you of her svevere plane crash phobia. You start to pay attention when she tells you she always keeps a portable transmitter in her blue carry on. After searching through what seemed like a million blue suitcases, you find the right bag. The transmitter is straght forward and still in tack. You recieve a signal and rescue comes two hours later. Congratulations, you saved yourself and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 29:
                        situationLabel.Text = "You are able to locate a flight attendant with an injured leg on the beach. You convince her to come to the cockpit by telling her that you will fix her up with the resources from the first aid kit supplies. When you get there, together you successfully run the transmitter, recieve a signal and rescue comes two hours later. Congratulations, you saved yourself and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 30:
                        ...
                        break;
                    case 31:
                        situationLabel.Text = "You continue to search the cockpit for indicators, instructions or anything that would help with the maintnance od the transmitter. After awhile you locate an instruction manual and get the transmitter to work all by yourself, you recieve a signal and rescue troops arrive two hours later. Congratulations, you saved yourself and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 32:
                        situationLabel.Text = "You are in the woods calling for Hulio when you hear a distant barking. You get excited when you spot a German shepard, when it begins to run you follow it all the way to a small town. The people explain you are on an island called Pitcairn, located in the middle of the Pacific. Congratulations, you and the dog saved yourselves and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 33:
                        ...
                        break;
                    case 34:
                        situationLabel.Text = "Your flare goes unnoticed but it does clip a tree which causes a large forest fire to igniting the remainder of the tail and causing large explosion killing you and many other of the remaining survivors are blown to smitherines.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 35:
                        situationLabel.Text = "A boat was just close enough to notice your flare. They notify search and rescue, who come within just a few hours. Congratulations you have saved yourself and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 36:
                        situationLabel.Text = "It is now night time, you are ready to fire your flare and because you only have one chance and you need to concentrate. Just as you are about to shoot, a large animal burst out of the bushes and is now coming at you approach the situation by...";
                        aOutputLabel.Text = "Go on the offense, grab a near by branch and attack.";
                    ...
                    case 37:
                        ...
                        break;
                    case 38:
                        situationLabel.Text = "You find water in the forest, it is so glorious you decide to rinse off but you fall in and then, oh no, water fall ahead. It's not quite as fun as a water slide, as it ends in your long lasting death.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 39:
                        ...
                        break;
                    case 40:
                        situationLabel.Text = "after searching you are able to find the frontend of the plane where you locate the transmitter too bad it was getting dark and had no knowledge in technology, you got frustrated ending in electrocution.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 41:
                        situationLabel.Text = "You start to walk around the beach but it gets dark fast and you are now very far from the other survivors. You are now tired so you try to sleep by the edge of a the small mountain, unfortunately, large falling rock crush you in your sleep.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 42:
                        situationLabel.Text = "Because of the large amount of smoke coming from the back end of the plane you are able to locate the tail and with that the flare gun. There is only one snall problem you only have one flare. Because it is now dark out there is an 85% chance that your flare will be seen.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    case 43:
                        situationLabel.Text = "Your flare goes unnoticed but it does clip a tree which causes a large forest fire, igniting the remainder of the tail and causing large explosion. Blowing you and many other survivors to smitherines. Atleast you went out with a bang";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    ...
                    case 46:
                        ...
                        break;
                    case 47:
                        situationLabel.Text = "You find no food or water but you do find a portable transmitter in full function. The transmitter is straght forward and still in tack. You recieve a signal and rescue comes two hours later. Congratulations, you saved yourself and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    ...
                    case 50:
                        ...
                        break;
                    case 51:
                        situationLabel.Text = "Unfortunately you catch something too big and it drags you in. Atleast someone had a snack.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    ...
                    case 54:
                        ...
                        break;
                    case 55:
                        situationLabel.Text = "The dog is calm and appears to have a collar. His name appears to be Hulio, you assume that he belonged to a passenger on the plane so when it runs you follow it. After what seems to have been miles of running you realize the dog has brough you to civilization. Congratulations, you and Hulio have saved yourselves and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
                    ...
                    case 59:
                        ...
                        break;
                    case 60:
                        situationLabel.Text = "Your flare is spotted by someone out boating, rescue comes a few hours later. Congratulations, you have saved yourself and many others.";
                        aOutputLabel.Text = "";
                        bOutputLabel.Text = "";
                        cOutputLabel.Text = "";
                        break;
